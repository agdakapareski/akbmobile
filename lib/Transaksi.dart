...
class _TransaksiState extends State<Transaksi> {
  ...
  Future<dynamic> getTotal() async {
    final response = await http.get(
        Uri.parse('http://192.168.1.6:8000/api/totalMobile/' + widget.nama));
  ...
  Future<List<Order>> fetchOrder() async {
    var url = 'http://192.168.1.6:8000/api/pesananMobile/' + widget.nama;
  ...
  Future<TransaksiModel> createTransaksi(String nama_customer,
      String total_transaksi, String status_transaksi) async {
    var url = Uri.parse('http://192.168.1.6:8000/api/transaksiMobile');
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.start,
                    children: <Widget>[Text("Customer : "), Text(widget.nama)],
                  ),
                ),
                Divider(
                  indent: 13,
      ...
      child: Column(
        children: <Widget>[
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.start,
            children: <Widget>[
              Text(_order[i].jumlah_pesanan.toString() +
                  " x " +
                  "Rp. " +
                  _order[i].harga.toString()),
              Expanded(
                child: Row(
